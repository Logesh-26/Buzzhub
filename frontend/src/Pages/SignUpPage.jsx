                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <input
                                id="username"
                                type="text"
                                className="w-full px-4 py-2 border border-gray-400 bg-gray-700 text-white rounded-lg focus:outline-none
                        ...
                        <div>
                            ...
                            <input
                                id="email"
                                type="email"
                                className="w-full px-4 py-2 border border-gray-400 bg-gray-700 text-white rounded-lg focus:outline-none focus:ring-2
                        ...
                        <button
                            type="submit"
                            className="w-full py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold rounded-lg shadow-md hover:from-blue-600 
                        hover:to-purple-600 transition-all duration-[500ms] ease-in-out transform hover:scale-105 cursor-pointer">
                            Sign Up
                        </button>
                    </form>
