...
const ProfilePage = () => {
    ...
    return ( 
        <div className="min-h-screen flex items-center justify-center">
            <div className="bg-gradient-to-r from-gray-500 to-gray-800 rounded-2xl p-8 w-full max-w-md relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    <div className="relative mb-6">
                        ...
                        <label
                            ...
                            className="absolute bottom-2 right-2 bg-gray-400 p-2 rounded-full shadow hover:bg-blue-100 transition-all duration-[400ms] cursor-pointer"
