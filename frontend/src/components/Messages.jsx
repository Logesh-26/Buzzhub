...
const Messages = () => {
    ...
    const { selectedUser, getMessages, messages, listenForNewMessage, stopListeningForMessages } = chatstore();
    ...
    }, [getMessages, selectedUser,listenForNewMessage, stopListeningForMessages]);

    //Auto scroll to bottom when new message changes
    useEffect(() => {
    ...
    if (messages.length === 0) {
        return <div className="flex-1 flex items-center justify-center text-gray-400 p-2"> 
