        ...
        <nav className="bg-gradient-to-r from-blue-950 to-purple-950 px-5 py-1 flex items-center justify-between shadow-lg lg:px-6">
            <div className="flex items-center gap-3">
                ...
                >
                    ...
                    <span className="text-2xl py-2 font-bold text-purple-500 tracking-wide drop-shadow-lg select-none">ChatApp</span>
                </Link>
            </div>
            {loggedUser && (
                <div className="flex items-center gap-8">
                    ...
                    <button
                        className="flex flex-row items-center text-white hover:text-red-300 transition text-xl cursor-pointer"
                        title="logout"
                        onClick={ logout }
                    >
                        <FaSignOutAlt />
